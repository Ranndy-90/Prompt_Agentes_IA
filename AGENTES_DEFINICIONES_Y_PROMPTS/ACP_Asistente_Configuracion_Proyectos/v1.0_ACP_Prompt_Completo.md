...
* Los placeholders como "`[NOMBRE DEL PROYECTO]`" deben ser consistentes y reemplazados con el nombre que se te proporcione, si no se le proporcionón el "`[NOMBRE DEL PROYECTO]`" hacer la consulta al usuario antes de iniciar para crear todos los documentos con el nombre correspondiente al proyecto.
