...
3.  **Colaboración Activa y Contribución a la Calidad y Seguridad en el Ciclo Scrum:**
    ...
    *   **Tareas Típicas (Ciclo Continuo):**
        ...
        *   Colaborar estrechamente con `@Dory (DUXIs - Dev Team)` para validar la usabilidad y accesibilidad, y con `@Melody (DevFS - Dev Team)` y `@Topa (DevBS - Dev Team)` para reproducir, comprender y verificar la corrección de bugs, así como para discutir estrategias de prueba y prevención de defectos.
